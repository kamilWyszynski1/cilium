...
func (in *CiliumEndpointSlice) DeepCopyInto(out *CiliumEndpointSlice) {
	*out = *in
	...
	if in.Labels != nil {
		...
		*out = make(map[string]IdentityLabels, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IdentityLabels) DeepCopyInto(out *IdentityLabels) {
	*out = *in
	if in.Labels != nil {
		in, out := &in.Labels, &out.Labels
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IdentityLabels.
func (in *IdentityLabels) DeepCopy() *IdentityLabels {
	if in == nil {
		return nil
	}
