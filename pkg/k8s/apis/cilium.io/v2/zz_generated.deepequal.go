...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumNodeSlice) DeepEqual(other *CiliumNodeSlice) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumNodeSliceCore) DeepEqual(other *CiliumNodeSliceCore) bool {
	if other == nil {
		return false
	}
	...
	if !in.IPAMStatus.DeepEqual(&other.IPAMStatus) {
		return false
	}
