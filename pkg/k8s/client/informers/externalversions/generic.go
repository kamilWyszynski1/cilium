...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v2.SchemeGroupVersion.WithResource("ciliumnodeslices"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cilium().V2().CiliumNodeSlices().Informer()}, nil
